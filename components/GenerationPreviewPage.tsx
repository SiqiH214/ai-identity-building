...
export default function GenerationPreviewPage({
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-gray-50 to-white z-50 flex items-center justify-center py-safe">
      {/* Phone-sized container */}
      <div className="w-full max-w-md mx-auto min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white">
        {/* Header */}
